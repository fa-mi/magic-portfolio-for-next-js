    ...
    work: {
        ...
        experiences: [
            ...
            },
            {
                ...
                role: 'Junior Manager',
                highlight: {
                    title: 'CAMS — Card Management System',
                    description: <>My main highlight at BRI: owning the <b>Card Management System (CAMS)</b> end-to-end — the core platform behind debit card issuance, activation, and lifecycle management — and leading its <b>migration to cloud infrastructure</b> for better scalability and reliability across BRI's branch network.</>,
                    tags: ['Core Ownership', 'Cloud Migration', 'Debit Card Lifecycle']
                },
                achievements: [
                    <>Card Management System (CAMS) — core platform for debit card issuance & lifecycle</>,
                    <>CAMS on Cloud — led migration of CAMS to cloud infrastructure</>,
                    <>Debit Card Activation on Project Government Social Aid (CAMS)</>,
                    <>Debit Card Request on BRIMO (CAMS)</>,
                    <>Debit Card Contactless on BRIMO (CAMS)</>,
                    <>Debit Card Channel Activation (CAMS)</>,
                    <>Debit Card Inventory Transfer Branch Office (CAMS)</>,
                    <>Debit Card Inventory Third Party (CAMS)</>,
                    <>Debit Card Dynamic Currency Matching (CAMS)</>,
                    <>NFC Payment using Tokenize Technology (CAMS)</>,
                    <>Brizzi Card Sale Branch Office (CAMS)</>,
